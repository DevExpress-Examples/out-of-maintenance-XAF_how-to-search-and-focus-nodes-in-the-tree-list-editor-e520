...
namespace WinSolution.Module.Win {
    public partial class FilterTreeListViewController : ViewController {
        ...
        public void DoSearchInternal(string textToSearch) {
            while (currentNode != null) {
                ...
                if (value.Contains(textToSearch)) {
                    ...
                    currentNode = GetNextNode(currentNode, treeList.Nodes);
                    if (currentNode == null)
                        currentNode = startNode;
                    return;
                }
        ...
        protected TreeListNode GetNextNode(TreeListNode node, TreeListNodes rootNodes) {
            ...
            if (node.ParentNode != null) {
                ...
                while (node == owner.LastNode) {
                    ...
                    owner = node.ParentNode == null ? rootNodes : node.ParentNode.Nodes;
                }
