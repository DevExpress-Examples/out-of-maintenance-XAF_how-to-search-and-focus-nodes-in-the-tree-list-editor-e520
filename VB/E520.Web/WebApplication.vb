...
Namespace E520.Web
    ...
    Public Partial Class E520AspNetApplication
        ...
        Private module3 As [Module].E520Module

        Private module4 As [Module].Web.E520AspNetModule
        ...
        Private Sub E520AspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
            e.Updater.Update();
            e.Handled = true;
#Else
...
#End If
        ...
        Private Sub InitializeComponent()
            ...
            module3 = New [Module].E520Module()
            module4 = New [Module].Web.E520AspNetModule()
            ...
            ' 
            ApplicationName = "E520"
            CollectionsEditMode = Editors.ViewEditMode.Edit
            Modules.Add(module1)
            Modules.Add(module2)
            Modules.Add(module3)
            Modules.Add(module4)
            ...
            AddHandler DatabaseVersionMismatch, New EventHandler(Of DatabaseVersionMismatchEventArgs)(AddressOf E520AspNetApplication_DatabaseVersionMismatch)
